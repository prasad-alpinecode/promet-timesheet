jQuery(document).ready(function( $ ) {
    ...
    $('.hm-btn').bind("tap",function(e){
        $('.off-canvas').toggleClass('open');
        $('body').toggleClass('expand');
        $('.hm-btn').toggleClass('open');
    });

    $('.overlay').bind("tap",function(e){
        $('.off-canvas').toggleClass('open',false);
        $('body').toggleClass('expand',false);
        $('.hm-btn').toggleClass('open',false);
    });

    $('.btm-menu > button').bind("tap",function(e){
